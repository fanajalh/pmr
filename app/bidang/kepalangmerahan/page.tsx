...
import { Gamepad2, BrainCircuit, Trophy, Sparkles } from "lucide-react"
        ...
        <section className="relative h-[60vh] flex items-center justify-center overflow-hidden bg-slate-100/30 dark:bg-slate-950/20 pt-20">
          ...
          <div className="relative z-20 container mx-auto px-6 text-center max-w-4xl space-y-6">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-light tracking-tighter text-slate-900 dark:text-white leading-none font-heading uppercase">
              GAME <span className="font-semibold text-primary">GP</span>
            </h1>

            <p className="text-sm md:text-lg text-slate-500 dark:text-slate-400 font-light max-w-2xl mx-auto leading-relaxed">
              Belajar nilai dan sejarah kemanusiaan lewat simulasi interaktif, permainan kelompok, dan petualangan seru.
            </p>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mb-32">
              ...
              <div className="lg:col-span-7 space-y-12">
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[10px] font-bold tracking-[0.4em] text-primary uppercase">Fun & Learn</span>
                  </div>
                  <h2 className="text-4xl font-light tracking-tighter text-slate-900 dark:text-white leading-tight font-heading uppercase">
                    Metode Belajar Paling Aktif!
                  </h2>
                  <p className="text-base text-slate-500 dark:text-slate-400 font-light leading-relaxed">
                    Game Kepalangmerahan adalah bidang PMR yang merancang metode edukasi berbasis permainan interaktif. Melalui simulasi peran, kuis ketangkasan, dan teka-teki taktis, kami menanamkan 7 prinsip dasar Palang Merah secara mendalam, menyenangkan, dan berkesan bagi anggota.
                  </p>
                </div>
              ...
              <div className="lg:col-span-5 space-y-6">
                <div className="space-y-2 mb-8">
                  ...
                  <p className="text-xs text-slate-400">Tujuan pembelajaran kepalangmerahan yang menyenangkan.</p>
                </div>
                ...
                <div className="p-6 bg-card dark:bg-white/[0.01] border border-border/40 dark:border-white/5 rounded-xl flex gap-5 hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors duration-300 shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-slate-900 dark:text-white font-heading">Pemahaman Materi</h4>
                    <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-light mt-1">
                      Memahami nilai, sejarah, dan landasan organisasi kepalangmerahan secara komprehensif tanpa kejenuhan.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 bg-card dark:bg-white/[0.01] border border-border/40 dark:border-white/5 rounded-xl flex gap-5 hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors duration-300 shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-slate-900 dark:text-white font-heading">Keterampilan Tim</h4>
                    <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-light mt-1">
                      Melatih kerja sama kelompok, kecepatan analisis taktis, komunikasi efektif, dan ketahanan di bawah tekanan.
                    </p>
                  </div>
                </div>
                ...
                <div className="p-6 bg-card dark:bg-white/[0.01] border border-border/40 dark:border-white/5 rounded-xl flex gap-5 hover:bg-slate-50 dark:hover:bg-white/[0.02] transition-colors duration-300 shadow-sm">
                  ...
                  <div>
                    <h4 className="font-bold text-lg text-slate-900 dark:text-white font-heading">Sikap & Karakter</h4>
                    <p className="text-xs md:text-sm text-slate-500 dark:text-slate-400 font-light mt-1">
                      Membentuk kepribadian relawan yang peka sosial, disiplin, berintegritas tinggi, dan senantiasa berempati.
                    </p>
                  </div>
                </div>
